...
<div class='parent'>
  ...
  <p class='text--center' id='pnono'>First Name: <span class='spanclass'>............</span></p>
  <p class='text--center' id='pnono'>Last  Name: <span class='spanclass'>............</span></p>
  </div>
  </div>
  <div class='parent'>
  <div class='grid' id='block'>
    <form method='POST' class='form login' action='./py.py'>
      <div class='form__field'>
        <label for='login__username'><svg class='icon'><use xmlns:xlink='http://www.w3.org/1999/xlink' xlink:href='#user'></use></svg><span class='hidden'>Username</span></label>
        <input id='login__username' type='text' name='namepost' class='form__input' placeholder='First Name' required>
      </div>
      <div class='form__field'>
        <label for='login__username'><svg class='icon'><use xmlns:xlink='http://www.w3.org/1999/xlink' xlink:href='#user'></use></svg><span class='hidden'>Username</span></label>
        <input id='login__username' type='text' name='last_namepost' class='form__input' placeholder='Last Name' required>
      </div>
      <div class='form__field'>
