...
/*   Updated: 2024/02/13 23:52:19 by abizyane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		GetRequest::checkHeaders(void){
...
e_statusCode	GetRequest::parseRequest(std::string &request){
	...
	(void)request;
	(void)_parse;
	// switch (_parse.getParseState()){
	// 	case Headers:
	// 		status = _parseHeader(request);
	// 		break;
	// 	case Body:
			
	// 		status = _parseBody(request);
	// 		break;
	// 	case Done:
	// 		break;
	// 	default:
	...
	return (static_cast<e_statusCode>(status));
}
